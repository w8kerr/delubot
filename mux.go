...
func init() {
	...
	if env == "dev" {
		...
		Router.Route("avatar", "Set the bot's avatar", Router.Avatar, models.AL_DEV)
		Router.Route("nickname", "Set the bot's nickname", Router.Nickname, models.AL_DEV)
		// Router.Route("proposal", "Create a sign-off sheet following the message.", Router.Proposal, models.AL_STAFF)
		Router.Route("8ball", "Receive DeluBot's guidance", Router.EightBall, models.AL_STAFF)
