...
func init() {
	...
	if env == "dev" {
		...
		Router.Route("v", "Grant current roles and copy the verification to the role sync spreadsheet", Router.Verify, models.AL_STAFF)
		...
		Router.Route("addguerrilla", "Add a guerrilla stream to the schedule manually ('yyyy/mm/dd hh:mm <timing> <title>')", Router.AddStream, models.AL_STAFF)
